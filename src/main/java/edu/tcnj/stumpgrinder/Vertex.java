...
public class Vertex<T>
{
  ...
  /**
   * Constructs a vertex with a label, no data and no adjacent vertices.
   *
  ...
  /**
   * Constructs a vertex with a label, data, and no adjacent vertices.
   *
   * @param label The unique label to be used to identify this vertex.
   ...
   */
  public Vertex(String label, Collection<? extends Vertex<T>> adjacent)
    {
      this.label    = label;
      this.data     = null;
      this.adjacent = new ArrayList<Vertex<T>>();
   ...
   */
  public Vertex(String label, T data,
                Collection<? extends Vertex<T>> adjacent)
    {
      this.label    = label;
      this.data     = data;
      this.adjacent = new ArrayList<Vertex<T>>();
   ...
   */
  public void setAdjacent(Collection<? extends Vertex<T>> adjacent)
    {
   ...
   */
  public boolean makeAdjacent(Vertex<T> vertex)
    {
   ...
   */
  public boolean makeNotAdjacent(Vertex<T> vertex)
    {
      if (isAdjacent(vertex))
        {
